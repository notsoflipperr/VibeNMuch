# Codecademy Jammming Project a.k.a VibeNMuch
Officially under the alias of Jammming on the CodeCademy website, but took the liberty to name it something different.
...
- Populate Results List — VibeNMuch displays the list of returned tracks from the user’s query.
